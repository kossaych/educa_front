...
const Chapiter = (props) => {  
    ...
    useEffect(()=>{
      ...
      fetch("https://kossaych.pythonanywhere.com/content/api/chapiter/" +(props.params.id), {
        method: "get",
        headers: {
      ...
      .then((response) => {
        ...
        .then((data) => { 
             if (data) {
                setChapiter(data[0])   
                changeContent(data[0].courses[0].videos_cour[0])  
                setTeacher(data[0].courses[0].teacher) 
            }
        }) 
    },[])
                    ...
                    <div  className='w-full '> 
                            ...
                            { contentPages && (<div className=' overflow-scroll h-96' width="100%"  >  
                                                    {contentPages.map(page => (
                                                        <img src={'https://kossaych.pythonanywhere.com/media/' + page.url} key={page.id} alt="PDF Content" /> 
                    ...
                    <div className="mt-2 w-full   rounded-md " >
                            ...
                            {(contentUrl || contentPages) ? (
                                        <div className="flex items-center">
                                            <img src= {"https://kossaych.pythonanywhere.com/media/" + teacher.imgProfile}    className="rounded-full w-10 h-10  bg-slate-300 "></img > 
                            ...
                            {(contentUrl || contentPages) ? (<div className="flex items-center justify-between m-2">
                                ...
                                <p>    
                                    <a href = {"https://kossaych.pythonanywhere.com/media/"+content.attachment} class="button flex bg-red-300 rounded-lg p-1  items-center m-2">  
