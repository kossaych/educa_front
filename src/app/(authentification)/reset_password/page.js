...
function ResetPassword() {
  ...
  const sendEmail = () => {
    setIsWait(true);
    fetch("https://educabackend.pythonanywhere.com/content/api/reset_password/", {
      method: "post",
      headers: {
  ...
  const sendVerificationCode = () => {
    setIsWait(true);
    fetch("https://educabackend.pythonanywhere.com/content/api/check_code/", {
      method: "post",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const sendPassword = () => {
    setIsWait(true);
    fetch("https://educabackend.pythonanywhere.com/content/api/set_password/", {
      method: "post",
      headers: {
        "Content-Type": "application/json",
      },
