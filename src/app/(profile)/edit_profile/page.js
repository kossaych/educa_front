...
function Register() {
    ...
    useEffect(()=>{
      ...
      fetch("https://kossaych.pythonanywhere.com/content/api/profile/", {
            method: "get",
            headers: {
      ...
      fetch("https://kossaych.pythonanywhere.com/content/api/get_disciplines/", {
        method: "get",
        headers: {
          "Content-Type": "application/json",
        },
        ...
        fetch("https://kossaych.pythonanywhere.com/content/api/get_levels/", {
      method: "get",
      headers: {
        "Content-Type": "application/json",
      },
      ...
      fetch("https://kossaych.pythonanywhere.com/content/api/get_addreses/", {
          method: "get",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    return (
        ...
        <div className="text-center rounded bg-white  border border-blue-400  my-3 p-1 mx-3 "  > 
                                ...
                                <div> 
                                  ...
                                  {isWaitLoading == false ? <img className="w-full object-cover object-center" src={"https://kossaych.pythonanywhere.com/media/" + user.imgCoverUrl} alt = 'cover image'/> : <div  className="w-8 h-8 border-4 border-gray-200 border-dashed rounded-full animate-spin m-auto z-40"></div>}
                                  ...
                                  {imgProfile ? (
                                    ...
                                    <>
                                            <div className="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden flex justify-end items-end ">
                                              ...
                                              {isWaitLoading == false ?  <img className="object-cover object-center h-32  w-full" src= {"https://kossaych.pythonanywhere.com/media/" + user.imgProfileUrl} alt = 'profile image'/> : <div  className="w-8 h-8 border-4 border-gray-200 border-dashed rounded-full animate-spin m-auto"></div>}
                                            </div>  
